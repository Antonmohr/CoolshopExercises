...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Delivery Date: " + deliveryOrder1.getDeliveryDate());
        DeliveryCalculator deliveryOrder2 = new DeliveryCalculator(order2);
        System.out.println("Delivery Date: " + deliveryOrder2.getDeliveryDate());
        DeliveryCalculator deliveryOrder3 = new DeliveryCalculator(order3);
        System.out.println("Delivery Date: " + deliveryOrder3.getDeliveryDate());
        DeliveryCalculator deliveryOrder4 = new DeliveryCalculator(order4);
        System.out.println("Delivery Date: " + deliveryOrder4.getDeliveryDate());
        DeliveryCalculator deliveryOrder5 = new DeliveryCalculator(order5);
        System.out.println("Delivery Date: " + deliveryOrder5.getDeliveryDate());
    }
}